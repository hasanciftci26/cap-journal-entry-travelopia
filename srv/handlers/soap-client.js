...
class SOAPClient {
    ...
    async getSoapService(service, wsdl, endpoint) {
        ...
        // Instantiate the service using that http client. Use SOAP 1.2 version with forceSoap12Headers param
        return soap.createClientAsync(wsdl, { httpClient: oHTTPClient, forceSoap12Headers: true });
    }
}
